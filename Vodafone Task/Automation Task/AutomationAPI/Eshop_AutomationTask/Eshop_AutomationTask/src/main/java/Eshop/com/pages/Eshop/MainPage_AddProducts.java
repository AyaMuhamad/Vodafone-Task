...
//    By CartItemNumber = By.cssSelector(".cart-card.ng-star-inserted");
    ...
    public void CheckIfThreeItemsAddedToTheCart() {
        ...
        WebDriverWait localWait = new WebDriverWait(driver, Duration.ofSeconds(80));
        localWait.until(ExpectedConditions.visibilityOfElementLocated(CartCount));
...
//
//        WebDriverWait CartListWait = new WebDriverWait(driver, Duration.ofSeconds(80));
//        CartListWait.until(ExpectedConditions.visibilityOfElementLocated(CartItemNumber));
//
//        List<WebElement> items = driver.findElements(CartItemNumber);
//        int actualCount = items.size();
//        Assert.assertEquals(actualCount, 3, "Expected 3 items in the cart, but found " + actualCount);
//    }
}
